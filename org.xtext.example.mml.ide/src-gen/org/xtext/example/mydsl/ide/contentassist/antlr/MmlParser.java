...
public class MmlParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MmlGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getSGDAccess().getAlternatives_1(), "rule__SGD__Alternatives_1");
			builder.put(grammarAccess.getGTBAccess().getAlternatives_1(), "rule__GTB__Alternatives_1");
			...
			builder.put(grammarAccess.getSVRAccess().getGroup_2(), "rule__SVR__Group_2__0");
