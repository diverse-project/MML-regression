...
public class MmlSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == MmlPackage.eINSTANCE)
			...
			case MmlPackage.FORMULA_ITEM:
				...
				return; 
			case MmlPackage.GTB:
				sequence_GTB(context, (GTB) semanticObject); 
				return; 
			...
			case MmlPackage.RANDOM_FOREST:
				...
				return; 
			case MmlPackage.SGD:
				sequence_SGD(context, (SGD) semanticObject); 
				return; 
			case MmlPackage.SVR:
	...
	/**
	 * Contexts:
	 *     MLAlgorithm returns GTB
	 *     GTB returns GTB
	 *
	 * Constraint:
	 *     {GTB}
	 */
	protected void sequence_GTB(ISerializationContext context, GTB semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	/**
	 * Contexts:
	 *     MLAlgorithm returns SGD
	 *     SGD returns SGD
	 *
	 * Constraint:
	 *     {SGD}
	 */
	protected void sequence_SGD(ISerializationContext context, SGD semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	/**
	 * Contexts:
	 *     MLAlgorithm returns SVR
	 *     SVR returns SVR
	 *
	 * Constraint:
	 *     (C=FLOAT? kernel=SVMKernel?)
	 */
