...
public interface MmlFactory extends EFactory
{
  ...
  /**
   * Returns a new object of class '<em>SGD</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>SGD</em>'.
   * @generated
   */
  SGD createSGD();

  /**
   * Returns a new object of class '<em>GTB</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>GTB</em>'.
   * @generated
   */
  GTB createGTB();
